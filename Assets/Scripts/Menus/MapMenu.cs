...
public class MapMenu : MonoBehaviour
{
    ...
    {
        SceneManager.LoadScene(LevelManager.GetGameModeSceneId(SaveManager.GameMode.Campaign) + 1);
    }

    public void StartClassicFight()
    {
        SceneManager.LoadScene(LevelManager.GetGameModeSceneId(SaveManager.GameMode.Classic) + 1);
    }
